...
-- Tiempo de generación: 28-08-2023 a las 16:30:58
...
INSERT INTO `enfermeras` (`nombres`, `numeroficha`, `curp`) VALUES
('Myriam Esquivel', '7304', ''),
('Josefina Contreras', '1435', ''),
('Teresa Placio Cervantes', '7585', ''),
('Elena Monroy Uribe', '1184', ''),
('Luisa Velazquez De Anda', '5401', ''),
('Olga Lidia Villalpando', '1161', ''),
('Maria Gomez Gallardo Vazquez', '2444', ''),
('Martha Reyes Vilar', '5575', ''),
('Carmen Serrano Rios', '9088', ''),
('Mayela Sanz Pineda', '8455', ''),
('Lilia Rivas Sanchez', '7060', ''),
('Isabel Dosal Rubio', '5964', ''),
('Teresa Zamora Reyes', '7357', ''),
('Elva Luna Valenzuela', '1272', ''),
('Guillermina Espinosa Villar', '4520', ''),
('Julieta Aguilar Rueda', '1844', ''),
('Irene Abundis Mancilla', '9220', ''),
('Irma Morales Heredia', '2817', ''),
('Martha Concepcion Gonzalez', '9171', ''),
('Alicia Gallardo', '6015', ''),
('Lucia Fuentes', '8454', ''),
('Teresa Cordova', '5348', ''),
('Lourdes Renata Avalos', '2974', ''),
('Irene Gomez Blanco', '7262', ''),
('Araceli Favela Garcia', '1737', ''),
('Gabriela Rosales Ramirez', '1584', ''),
('Ana Julieta Noriega', '2167', ''),
('Rebeca Gonzalez Ocampo', '9527', ''),
('Magdalena Valdes Luna', '9474', ''),
('Katherine Muñoz Ruiz', '9544', ''),
('Angelica Montaño Prado', '2614', ''),
('Yadira Pascual Sauceda', '4074', ''),
('Monica Delgado Salazar', '9592', ''),
('Lilia Romero Mosqueda', '7911', ''),
('Rosalinda Aguirre Mercado', '4911', ''),
('Alicia Ruiz Herrera', '8278', ''),
('Maria Del Rosario Gallegos', '7717', ''),
('Judith Malagon Villegas', '4445', ''),
('Araceli Fizola Dueñas', '1737', ''),
('Isabel Aranda Vazquez', '2241', '');
